<template>
    <div class="container">
        <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-between py-3 mb-4 border-bottom">
            <a href="#" @click.prevent="$router.push('/')" class="h3 d-flex align-items-center col-lg-3 mb-2 mb-md-0 text-dark text-decoration-none">
                GET PET BACK
            </a>
            ...
            <div class="col-lg-3 text-end">
                <a href="#" @click.prevent="$router.push('/register')" type="button" class="btn btn-outline-primary me-2">Регистрация</a>
